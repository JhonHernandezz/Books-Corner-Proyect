...
export const getAllReservationEmployee = async(req, res) => {
    try {
...
export const getDateReservationEmployee = async(req, res) => {
    try {
...
export const getStatusReservationEmployee = async(req, res) => {
    try {
...
export let putReservationEmployee = async(req, res) => {
    try {
        const error = validationResult(req);
        if (!error.isEmpty()) return res.status(200).json({ status: 400, message: error.errors[0].msg });
